...
- For binary installer releases, follow
  [FFmpeg LGPL Compliance Notes](ffmpeg-lgpl-compliance.md) and publish the
  FFmpeg source archive generated by `scripts/make-ffmpeg-source-archive.sh`
